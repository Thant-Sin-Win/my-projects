...
| File | Description |
|------|-------------|
| `2024_All_sites_air_quality_hourly_avg_AIR-I-F-V-VH-O-S1-DB-M2-4-0.xlsx` | Original EPA dataset (raw hourly readings across all sites) |
| `clean_air_quality_data.csv` | Cleaned and pre-processed data ready for visualization |
